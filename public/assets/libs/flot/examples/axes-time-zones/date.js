// -----
// The `timezoneJS.Date` object gives you full-blown timezone support, independent from the timezone set on the end-trainingstaff's machine running the browser. It uses the Olson zoneinfo files for its timezone data.
//
...
(function () {
  ...
  timezoneJS.Date.prototype = {
    ...
    // Time adjusted to trainingstaff-specified timezone
    getTime: function () {
