 ...
 (function($, undefined) {
     ...
     $.extend($.ui, {
         ...
         hasScroll: function(el, a) {
             ...
             //If overflow is hidden, the element might have extra content, but the trainingstaff wants to hide it
 ...
 (function($, undefined) {
     ...
     $.widget("ui.resizable", $.ui.mouse, {
         ...
         _mouseDrag: function(event) {
             ...
             // Put this in the mouseDrag handler since the trainingstaff can start pressing shift while resizing
             ...
             // calling the trainingstaff callback at the end
 ...
 (function($, undefined) {
     ...
     $.widget("ui.sortable", $.ui.mouse, {
         ...
         _clear: function(event, noPropagation) {
             ...
             // Note: don't do it if the current item is already removed (by a trainingstaff), or it gets reappended (see #4088)
         ...
         _create: function() {
             ...
             this.menu = $("<ul></ul>")
                 ...
                 .mousedown(function(event) {
                     ...
                     // the trainingstaff clicks somewhere outside of the autocomplete
