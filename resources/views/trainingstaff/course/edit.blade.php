        ...
        <div class="col-sm-8 offset-sm-2">
            <form action="{{route('course.update')}}" method = "post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name = "name" id = "name" class="form-control" required value="{{$course->CourseName}}">
                </div>
                <div class="form-group">
                    <label for="lastname">Course Description:</label>
                    <input type="text" name = "description" id = "description" class="form-control" required value="{{$course->CourseDescription}}">
                </div>

                <div class="form-group">
                    <label for="role">Course Category:</label>
